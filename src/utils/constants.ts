...
export const CALCULATOR_CONTENT = {
  ...
  disclaimer: 'TrustMonitor payouts are capped per tier. Professional tier caps at $500/incident.',
} as const;
...
export const GUARANTEE_CONTENT = {
  ...
  description: 'We pay when we fail to detect outages. No service credits. Actual compensation.',
  tiers: [
    {
      name: 'Standard',
      price: 499,
...
export const FOOTER_CONTENT = {
  disclaimer: 'TrustMonitor is a pre-launch product. This site validates founding customer interest. No monitoring services are currently operational.',
  legal: [
...
export const SEO = {
  ...
  ogImage: '/og-image.png', // TODO: Create
  twitterHandle: '@trustmonitor', // TODO: Create
} as const;
